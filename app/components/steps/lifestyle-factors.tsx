...
import { sleepPatternOptions, stressLevelOptions, sunExposureOptions, SunParticles } from '~/lib/lifestyle-options';
...
const LifestyleFactors = ({ step }: { step: number }) => {
  ...
  return (
    <Card noScale className="border-none shadow-none">
      <CardHeader>
        <CardTitle className='text-4xl font-serif mb-4 text-left md:text-center'>Vaši življenjski dejavniki</CardTitle>
        <CardDescription>
          Pomagajte nam razumeti vaš vsakdanjik, da prilagodimo nego vaše kože.
        </CardDescription>
      </CardHeader>
                        ...
                        <Label className="text-lg font-semibold flex items-center gap-2">
                          ...
                          {completedSections.sunExposure && (
                            <span className="flex items-center text-primary text-sm">
                              <Check className="w-4 h-4 mr-1" /> Izbrano
                            </span>
                          )}
                        </Label>
