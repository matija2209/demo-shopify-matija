...
export function IngredientPreferences({ step }: { step: number }) {
  ...
  return (
    <Card noScale className="border-none shadow-none">
      <CardHeader>
        <CardTitle>Preference sestavin</CardTitle>
        <CardDescription className="text-lg">
          Izberite sestavine, ki jih želite ali se jim želite izogniti v izdelkih za nego kože.
        </CardDescription>
      </CardHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleNext)} className="space-y-8">
                ...
                render={() => (
                  <FormItem>
                    <div className="flex items-center space-x-2 mb-6">
                      ...
                      <CardTitle className=''>Zaželene sestavine</CardTitle>
                    </div>
                ...
                render={() => (
                  <FormItem>
                    <div className="flex items-center space-x-2 mb-6">
                      ...
                      <CardTitle>Sestavine, ki se jim izogibamo</CardTitle>
                    </div>
                    <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="flex justify-between pt-6">
              ...
              <Button type="submit" front>Nadaljuj</Button>
            </div>
          </form>
        </Form>
      </CardContent>
