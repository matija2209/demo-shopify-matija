...
export function BudgetAllocation({ step }: { step: number }) {
  ...
  const budgetOptions = [
    {
      value: "LOW",
      label: "Cenovno ugodno",
      description: "Manj kot 50 € na mesec",
      range: "<50 €/mesec",
      icon: Wallet,
    ...
    {
      value: "MID_RANGE",
      label: "Srednji razred",
      description: "Uravnotežena investicija v nego kože",
      range: "50-150 €/mesec",
      icon: CreditCard,
    ...
    {
      value: "LUXURY",
      label: "Luksuzna nega kože",
      description: "Premium in visokokakovostni izdelki",
      range: "150+ €/mesec",
      icon: Diamond,
  ...
  return (
    <Card noScale className="border-none shadow-none">
      <CardHeader className="text-left md:text-center">
        ...
        >
          <CardTitle >
            Razporeditev proračuna
          </CardTitle>
          <CardDescription >
            Izberite mesečni proračun za izdelke za nego kože, da vam lahko prilagodimo priporočila.
          </CardDescription>
        </motion.div>
      </CardHeader>
      <CardContent>
