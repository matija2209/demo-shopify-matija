...
const ExfoliationTolerance = ({ step }: { step: number }) => {
  ...
  return (
    <Card noScale className="w-full mx-auto">
      <CardHeader className="space-y-2">
        <CardTitle className="text-2xl font-bold ">
          Preference pri eksfoliaciji
        </CardTitle>
        <CardDescription className="text-lg">
          Poiščimo popolno rutino eksfoliacije za vašo kožo
        </CardDescription>
      </CardHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleNext)} className="space-y-8">
            ...
            <div className="flex items-center gap-2 text-primary bg-primary/5 p-4 rounded-lg">
              ...
              <p className="text-sm font-medium">Pomagajte nam bolje razumeti vašo toleranco eksfoliacije</p>
            </div>
