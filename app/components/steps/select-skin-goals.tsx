  ...
  const renderAcneTypeOptions = () => (
    ...
    >
      {[
        {
          value: "HORMONAL",
          label: "Hormonske akne",
          description: "Običajno se pojavijo vzdolž čeljusti in brade, pogosto ciklično s hormonskimi spremembami",
          icon: "🌙"
        },
        {
          value: "STRESS_RELATED",
          label: "Akne povezane s stresom",
          description: "Izbruhnejo v obdobjih povečanega stresa, pogosto spremljane z vnetjem",
          icon: "😮‍💨"
        },
        {
          value: "CONGESTION",
          label: "Zamašenost por",
          description: "Majhne izbokline, črne pike in zamašene pore zaradi odvečnega olja in nečistoč",
          icon: "🔍"
        }
      ].map((option, index) => (
        <motion.div
  ...
  return (
    <Card noScale className="border-none shadow-none">
      <CardHeader className="text-left md:text-center">
        ...
        >
          <CardTitle>
            Vaši cilji nege kože
          </CardTitle>
          <CardDescription>
            Izberite glavno skrb za kožo, da vam ustvarimo popolno nego kože
          </CardDescription>
        </motion.div>
      </CardHeader>
      <CardContent>
              ...
              {form.getValues("skinGoal") === "ACNE" && (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-sm font-medium">Pomagajte nam bolje razumeti vaš tip aken</p>
                  </motion.div>
                  <FormField
                    control={form.control}
                    name="acneType"
